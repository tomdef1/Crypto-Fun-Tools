...
//IF USED INCORRECTLY THIS CAN RESULT IN 100% LOSS

//	↑	↑	↑	↑	↑	↑
//
//FORKED SPDX
//......NOW WORKS ON BSC LOL!
//
//⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣀⣤⠤⣄⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//⠀⠀⠀⠀⠀⠀⠀⣀⠴⠚⠉⠁⠀⠀⠀⠀⠀⠈⠉⠳⢤⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//⠀⠀⠀⠀⠀⣠⠚⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠑⣆⠀⠀⠀⠀⠀⠀⠀⠀
...
// .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
//| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
//| |  _________   | || |   _____      | || |      __      | || |    _______   | || |  ____  ____  | || |   ______     | || |     ____     | || |  ____  ____  | |
//| | |_   ___  |  | || |  |_   _|     | || |     /  \     | || |   /  ___  |  | || | |_   ||   _| | || |  |_   _ \    | || |   .'    `.   | || | |_  _||_  _| | |
//| |   | |_  \_|  | || |    | |       | || |    / /\ \    | || |  |  (__ \_|  | || |   | |__| |   | || |    | |_) |   | || |  /  .--.  \  | || |   \ \  / /   | |
//| |   |  _|      | || |    | |   _   | || |   / ____ \   | || |   '.___`-.   | || |   |  __  |   | || |    |  __'.   | || |  | |    | |  | || |    \ \/ /    | |
//| |  _| |_       | || |   _| |__/ |  | || | _/ /    \ \_ | || |  |`\____) |  | || |  _| |  | |_  | || |   _| |__) |  | || |  \  `--'  /  | || |    _|  |_    | |
//| | |_____|      | || |  |________|  | || ||____|  |____|| || |  |_______.'  | || | |____||____| | || |  |_______/   | || |   `.____.'   | || |   |______|   | |
//| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
//| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
// '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
//
...
contract FlashBot is Ownable {
    ...
    // Borrow base token by using flash swap from lower price pool and sell them to higher price pool
    ...
    /// alculate the maximum base asset amount to borrow in order to get maximum profit during arbitrage
    ...
    /// solution of quadratic equation: ax^2 + bx + c = 0, only return the positive solution
